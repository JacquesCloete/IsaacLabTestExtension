...
def design_scene():
    ...
    # Create separate groups called "Origin0", "Origin1", "Origin2" and "Origin3"
...
def run_simulator(
    ...
    # note: we only do this here for readability. In general, it is better to access entities directly from
