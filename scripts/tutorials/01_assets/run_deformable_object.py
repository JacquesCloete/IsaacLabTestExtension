...
parser = argparse.ArgumentParser(
    description="Tutorial on interacting with a deformable object."
)
...
def run_simulator(
    ...
    while simulation_app.is_running():
        ...
        if count % 250 == 0:
            ...
            pos_w = (
                torch.rand(cube_object.num_instances, 3, device=sim.device) * 0.1
                + origins
            )
        ...
        # write the kinematic target to simulation
        cube_object.write_nodal_kinematic_target_to_sim(nodal_kinematic_target)
