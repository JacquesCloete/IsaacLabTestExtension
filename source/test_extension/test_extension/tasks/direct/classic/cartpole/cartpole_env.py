"""
EnvCfg for cart-pole, created using the direct workflow.
"""
...
class CartpoleEnvCfg(DirectRLEnvCfg):
    ...
    # reset
    max_cart_pos = 3.0  # the cart is reset if it exceeds this position [m]
    ...
    # Note: see tutorials for how to add domain randomization and action/observation noise
